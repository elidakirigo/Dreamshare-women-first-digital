describe('Landing page', () => {
	...
	it('Contains call to action', () => {
		cy.getDataTest('CTO-test').should('contain.text', 'And find the perfect partner to fullfill it')
	})
	...
	it('Contains Movies heading', () => {
		cy.getDataTest('movies-test').should('contain.text', 'Most Trending Movies')
	})
	...
	it('Contains Holiday Content', () => {
		cy.getDataTest('holiday-test').should('contain.text', 'Discover holiday activity ideas')
	})
	...
	it('Contains Holiday Activity text', () => {
		cy.getDataTest('holiday-activity').should('contain.text', 'Create your holiday activity')
	})

	it('Contains Holiday Activity text', () => {
		cy.getDataTest('intrest-test').should('contain.text', 'Hi! What are your holiday interests?')
	})
})
