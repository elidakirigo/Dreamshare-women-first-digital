  ...
  return (
		<div className='flex flex-col items-center justify-center'>
			<div className='relative mt-4'>
				...
				{svg && <Image src={`/assets/SVGs/${svg}.svg`} width={40} height={40} alt='avatar icons' className={`z-1 absolute bottom-0 right-2 rounded-full border-4 border-white bg-[#661F20] p-2 shadow-md`} />}
			</div>
