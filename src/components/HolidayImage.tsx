	...
	return (
		...
		<div className={`col-span-1 ${span == 2 ? 'md:col-span-2' : 'md:col-span-1'} relative rounded-lg items-center md:h-80 overflow-hidden`}>
			<AspectRatio ratio={16 / 9}>
				<Image src={`/assets/formatted/${ImageUrl}.webp`} alt='' className='rounded-md object-cover shadow-lg md:min-h-80' fill={true} sizes='(max-height: 400px) 100%, (min-height: 320px)' />
			</AspectRatio>
