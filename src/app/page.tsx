  ...
  return (
    <main className="flex flex-col items-center justify-center">
      <header className="relative h-full min-h-[30rem] w-full">
        ...
        <div className="absolute left-0 top-0 h-full w-full bg-zinc-900/20 p-6 opacity-100 duration-500 md:flex md:flex-col md:items-center">
            ...
            <div>
              {session ? (
                <div className="flex gap-4 items-center justify-center">
                  <h1 className="text-white border border-white px-2 py-1 rounded-lg">
                    {session.user?.name}{" "}
                  </h1>
          ...
          <div className="mt-16 text-center text-white">
            ...
            <p className="max-w-68 mx-auto text-xl font-extralight md:w-full">
              And find the perfect partner to fullfill it
            </p>
            <Modal>
              <Button
                variant="ghost"
                className="mt-6 rounded-3xl bg-[#FF4E50] text-white hover:border hover:border-white hover:bg-transparent hover:text-white"
                size="sm"
              >
      ...
      <section className="w-full max-w-[1100px] px-3 py-12 text-center">
        ...
        <Button
          variant="outline"
          className="mx-auto mt-6 w-full rounded-3xl border-2 border-[#FF4E50] bg-transparent text-[#FF4E50] hover:bg-[#ff4e50] hover:text-white md:w-auto"
          onClick={Counter}
          size="sm"
        >
          Read More
      ...
      <section className="px-3 py-6 text-center">
        ...
        <Modal>
          <Button
            variant="outline"
            className="mx-auto mt-4 w-full rounded-3xl border-2 border-[#FF4E50] bg-transparent text-[#FF4E50] hover:bg-[#FF4E50] hover:text-white md:w-auto"
            size="sm"
          >
            See other partners
          </Button>
      ...
      <section className="w-full px-3 py-6 md:max-w-[600px]">
        ...
        <p className="my-6 text-center font-light">
          Hi! What are your holiday interests?
        </p>
        <div className="flex flex-col items-center justify-center md:flex-row">
          <input
            className="text-md w-full rounded-md border p-2 font-normal text-black outline-none"
            type="search"
            name="search"
          ...
          <Modal>
            <Button
              variant="ghost"
              className="m-6 w-full rounded-3xl bg-[#FF4E50] text-white hover:border hover:border-[#FF4E50] hover:bg-white hover:text-[#FF4E50] md:max-w-[200px]"
              size="sm"
            >
              Search partners
            </Button>
      ...
      <footer className="mt-4 flex w-full flex-col items-center border-t-2 border-[#FF4E50] p-4">
        <div className="flex w-full max-w-[1100px] flex-col items-center justify-center gap-6 md:flex-row md:items-start md:justify-between md:pt-8">
          ...
          <section>
            <span className="block text-center text-xs font-bold text-gray-500">
              DESIGNED BY
            </span>
            <Image
              src="/ARETO.svg"
